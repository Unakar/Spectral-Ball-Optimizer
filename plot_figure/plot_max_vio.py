...
# 保存图表（多种格式）
plt.savefig('/home/t2vg-a100-G2-1/a_xietian/dev/numeric/run_data/max_vio_comparison.png',
            dpi=300, bbox_inches='tight')
plt.savefig('/home/t2vg-a100-G2-1/a_xietian/dev/numeric/run_data/max_vio_comparison.pdf',
            bbox_inches='tight')
